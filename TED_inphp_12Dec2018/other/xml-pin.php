...
if(isset($_POST['submit'])){
	...
	<td>'. $data->FD_PERIODIC_INDICATIVE_UTILITIES->AUTHORITY_PERIODIC_INDICATIVE->NAME_ADDRESSES_CONTACT_PERIODIC_INDICATIVE_UTILITIES->CA_CE_CONCESSIONAIRE_PROFILE->TOWN.'</td>
	</tr>
	<tr>

...
if(isset($_POST['submit'])){
	...
	<td>'. $data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->TOWN.'</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">OFFICIALNAME</td>
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME .'</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">ADDRESS</td>
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->ADDRESS.'</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">POSTAL_CODE</td>
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->POSTAL_CODE.'</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">CONTACT_POINT</td>
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->CONTACT_POINT .'</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">ATTENTION</td>
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->ATTENTION .'</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">PHONE</td>
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->PHONE.'</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">E_MAIL</td>
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->E_MAILS->E_MAIL .'</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">FAX</td>
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->FAX.'</td>
	</tr>
	<tr>
	...
	<td>'.$data->FD_CONTRACT_AWARD->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->COUNTRY["VALUE"].'</td>
	</tr>
	<tr>
	...
	<td>'.$data->FD_CONTRACT_AWARD->OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE->DESCRIPTION_AWARD_NOTICE_INFORMATION->CPV->CPV_MAIN->CPV_CODE["CODE"];
	foreach ($data->FD_CONTRACT_AWARD->OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE->DESCRIPTION_AWARD_NOTICE_INFORMATION->CPV->CPV_ADDITIONAL as $cpv_ad ) $htmlData .= ",".$cpv_ad->CPV_CODE['CODE'];
	...
	<td>'.$data->FD_CONTRACT_AWARD->OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE->LOCATION_NUTS->NUTS["CODE"].'</td>
	</tr>
	<tr>

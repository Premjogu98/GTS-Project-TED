...
if(isset($_POST['submit'])){
	...
	<td>'. $data->FD_QUALIFICATION_SYSTEM_UTILITIES->CONTRACTING_ENTITY_QUALIFICATION_SYSTEM->NAME_ADDRESSES_CONTACT_QUALIFICATION_SYSTEM_UTILITIES->CA_CE_CONCESSIONAIRE_PROFILE->TOWN.'</td>
	</tr>
	<tr>

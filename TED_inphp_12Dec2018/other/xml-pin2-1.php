...
if(isset($_POST['submit'])){
	...
	<td>'. $data->FD_PRIOR_INFORMATION->AUTHORITY_PRIOR_INFORMATION->NAME_ADDRESSES_CONTACT_PRIOR_INFORMATION->CA_CE_CONCESSIONAIRE_PROFILE->TOWN.'</td>
	</tr>
	<tr>
	...
	<td>'.$data->FD_PRIOR_INFORMATION->OBJECT_WORKS_PRIOR_INFORMATION->CPV->CPV_MAIN->CPV_CODE["CODE"];
	...
	<td>'.$data->FD_PRIOR_INFORMATION->OBJECT_WORKS_PRIOR_INFORMATION->OBJECT_SUPPLY_SERVICE_PRIOR_INFORMATION->TYPE_CONTRACT_PLACE_DELIVERY->SITE_OR_LOCATION->NUTS["CODE"].'</td>
	</tr>
	<tr>

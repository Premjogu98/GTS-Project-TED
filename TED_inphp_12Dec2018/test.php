...
if(isset($_POST['submit'])){
	...
	foreach ($data->FD_RESULT_DESIGN_CONTEST->OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE->DESCRIPTION_AWARD_NOTICE_INFORMATION->CPV->CPV_ADDITIONAL as $cpv_ad ) $sector .= ",".str_replace("'","\'",$cpv_ad->CPV_CODE['CODE']);

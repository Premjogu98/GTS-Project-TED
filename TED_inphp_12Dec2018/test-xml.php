...
$path = "upload/folder1/146315_2015.xml";
getHtml($path, $db2, $db2);
...
//        echo $news_form_values."<br/>";
    ...
    $news_details = $award_detail . "<br/>" . $news_purchaser_details . "<br/>" . $news_contractor_details . "<br/>" . $news_reception_id . "<br/>" . $news_DELETION_DATE . "<br/>" . $news_lang_avl . "<br/>" . $news_contract_type . "<br/>" . $news_directive_value . "<br/>" . $news_cpv . "<br/>" . $news_ref_num . "<br/>" . $news_notice_data . "<br/>" . $news_codifdata . "<br/>" . $news_additioal_info . "<br/>" . $news_form_values_complete;

...
class DB {
     ...
     protected $db_host = '34.206.219.57';
    protected $db_user = 'developer5';
    protected $db_pass = 'vw5h5HASSv4RLtN4';
    protected $db_name = 'dms';
    private $con = '';
    ...
    public function get_country() {
        $temp_arr = array();
        $sql = "SELECT * FROM  tbl_country ORDER BY Country ASC";
        $res = $this->con->query($sql) or die(mysql_error());
        while ($row = $res->fetch_assoc()) {
            $temp_arr[] = $row;
        }

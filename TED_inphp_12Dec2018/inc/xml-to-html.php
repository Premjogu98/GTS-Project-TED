...
function contract_nature($xml) {
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
         if ($ml_ti['LG'] == 'EN') {
            ...
            if (!empty($ml_ti->TI_TEXT->P)) {
                $ti_text = $ml_ti->TI_TEXT->P;
            } else {
                $ti_text = $ml_ti->TI_TEXT;
            }
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            ...
            if ($ml_ti->TI_TEXT->P) {
                ...
                $ml_ti_shoertdescp = $ml_ti->TI_TEXT;
            }
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            ...
            if ($ml_ti->TI_TEXT->P) {
                ...
                $ml_ti_shortDescp = $ml_ti->TI_TEXT;
            }

...
function getHtml($path, $db2 = NULL, $db2 = NULL) 
{
    ...
    $COLL_OJDOCUMENT_TYPE = $xml->CODED_DATA_SECTION->REF_OJS->COLL_OJ;
    ...
    $CONTRACT_new = $xml->FORM_SECTION->F02_2014;
    $CONTRACT_Contract_notice = $xml->FORM_SECTION->CONTRACT;
    $DESIGN_CONTEST = $xml->FORM_SECTION->DESIGN_CONTEST;
    ...
    $CONTEST = $xml->FORM_SECTION->F12_2014;//$CONTEST = $xml->FORM_SECTION->DESIGN_CONTEST;
    $PERIODIC = $xml->FORM_SECTION->PERIODIC_INDICATIVE_UTILITIES;
    $QUALIFICATION_SYSTEM_WITH = $xml->FORM_SECTION->F07_2014;//QUALIFICATION_SYSTEM_UTILITIES;
    ...
    $CONTRACT_AWARD_Services = $xml->FORM_SECTION->OBJECT_CONTRACT->TYPE_CONTRACT;//Contract Award Services
    //Finding Contract Nature ...
    /* Code For Contract Notice on 18 Feb 2017 according to the new XML strcuture */
    $CONTRACT_NATURE = $xml->CODED_DATA_SECTION->CODIF_DATA->NC_CONTRACT_NATURE;

    //if (($CONTRACT_NATURE == 'Works' || $CONTRACT_NATURE == 'Supplies' || $CONTRACT_NATURE == 'Services') && $TD_DOCUMENT_TYPE == 'Contract notice' && (empty($CONTRACT) && empty($DEFENCE) && empty($UTILITIES) && empty($OTH_NOT) && empty($SIMPLIFIED_CONTRACT) && empty($PRIOR_INFORMATION_MOVE))) 
        if (($CONTRACT_NATURE == 'Works' || $CONTRACT_NATURE == 'Supplies' || $CONTRACT_NATURE == 'Services') && $TD_DOCUMENT_TYPE == 'Contract notice' && (empty($CONTRACT) && empty($UTILITIES) && empty($OTH_NOT) && empty($SIMPLIFIED_CONTRACT) && empty($PRIOR_INFORMATION_MOVE))) 
        {
        $flag = false;
        $file = $xml['DOC_ID'];
        $html_str = contract_nature($xml);
        $html_arr = explode("<!>", $html_str);
        $html = $html_arr['0'];
        $html_req = $html_arr['1'];
        $data = array("html" => "$html", "doc" => "$TD_DOCUMENT_TYPE", "fileId" => "$file", "ReqHtml" => $html_req);
        return $data;
       }
    ...
    if (!empty($DEFENCE) && $TD_DOCUMENT_TYPE == 'Contract notice') {
      ...
      if (!empty($CONTRACT_new) && $TD_DOCUMENT_TYPE == 'Dynamic purchasing system') 
          {   
        $flag = false;
        $file = $xml['DOC_ID'];
        $html = Dynamic_purchasing_system_4_all($xml);
        $data = array("html" => "$html", "doc" => "$TD_DOCUMENT_TYPE", "fileId" => "$file");
        return $data;
    }
    
    if(!empty($CONTRACT_Contract_notice) && $TD_DOCUMENT_TYPE == 'Dynamic purchasing system') 
          {   
        $flag = false;
        $file = $xml['DOC_ID'];
        $html = Dynamic_purchasing_system_4_all($xml);
    ...
    if(!empty($DESIGN_CONTEST) && $TD_DOCUMENT_TYPE == 'Dynamic purchasing system') 
          {   
        $flag = false;
        $file = $xml['DOC_ID'];
        $html = Dynamic_purchasing_system_4_all($xml);
...
//    //Edited by abhishek on 1Apr2017
    ...
    //    //Edited by abhishek on 18Apr2017
    if (!empty($DESIGN_CONTEST) && $TD_DOCUMENT_TYPE == 'Design contest') {
        $flag = false;
        $file = $xml['DOC_ID'];
        $html = design_contest($xml);
        $data = array("html" => "$html", "doc" => "$TD_DOCUMENT_TYPE", "fileId" => "$file");
     ...
     if (!empty($OTH_NOT) && $TD_DOCUMENT_TYPE == 'Contract notice') {
        $flag = false;
        $file = $xml['DOC_ID'];
        $html_str = call_expressions_interest($xml);
        $html_arr = explode("<!>", $html_str);
        $html = $html_arr['0'];
        $html_req = $html_arr['1'];
        $data = array("html" => "$html", "doc" => "$TD_DOCUMENT_TYPE", "fileId" => "$file", "ReqHtml" => $html_req);
    ...
    if (!empty($SIMPLIFIED_CONTRACT) && $TD_DOCUMENT_TYPE == 'Contract notice') {
        ...
        $flag = false;
        $file = $xml['DOC_ID'];
        $html_str = simplefied_interest($xml);
        $html_arr = explode("<!>", $html_str);
        $html = $html_arr['0'];
        $html_req = $html_arr['1'];
        $data = array("html" => "$html", "doc" => "$TD_DOCUMENT_TYPE", "fileId" => "$file", "ReqHtml" => $html_req);
      ...
      if(empty($QUALIFICATION_SYSTEM_WITH))
    {
  ...
  if (!empty($QUALIFICATION_SYSTEM_WITH) && ($TD_DOCUMENT_TYPE == 'Qualification system without call for competition' || $TD_DOCUMENT_TYPE == 'Qualification system with call for competition' )) 
        ...
        $flag = false;
        $file = $xml['DOC_ID'];
        $html = qualification_system_OldStyle($xml);
        $data = array("html" => "$html", "doc" => "$TD_DOCUMENT_TYPE", "fileId" => "$file");
        return $data;
    }
    
    if (!empty($CONTRACT_AWARD_Services) && $TD_DOCUMENT_TYPE == 'Contract award notice') {
        // echo $TD_DOCUMENT_TYPE."<br/>";
        // echo $xml['DOC_ID']."<br/>";
        $flag = false;
        $file = $xml['DOC_ID'];
...
//    if (!empty($PRIOR_INFORMATION) && $TD_DOCUMENT_TYPE == 'Prior information notice without call for competition') {
//        //echo $TD_DOCUMENT_TYPE."<br/>";
//        $flag = false;
//        $file = $xml['DOC_ID'];
//        $html = prior_information_notice($xml);
...
//    if (!empty($PERIODIC_INDICATIVE_UTILITIES) && $TD_DOCUMENT_TYPE == 'Prior information notice without call for competition') {
//        //echo $TD_DOCUMENT_TYPE."<br/>";
//        //echo $TD_DOCUMENT_TYPE."<br/>";
//        $flag = false;
//        $file = $xml['DOC_ID'];
...
//    }
    ...
    //Contract Award edited on 21Aug2017
//    if ($TD_DOCUMENT_TYPE == 'Contract award notice') {
//        // echo $TD_DOCUMENT_TYPE."<br/>";
//        // echo $xml['DOC_ID']."<br/>";
//        $flag = false;
//        $file = $xml['DOC_ID'];
//        $html = contract_awardNew($xml, $db2, $db2);
//        $data = array("html" => "$html", "doc" => "$TD_DOCUMENT_TYPE", "fileId" => "$file");
//        return $data;
//    }
    //Edited by Abhishek 1Apr2017
    ...
    //Contract Award not a proper solution...Abhishek 23-Oct2017
//    if ($flag) {
//        $file = $xml['DOC_ID'];
//        $tedId = $COLL_OJ . "-" . $NO_OJ;
//        $pubDate = YmdChnage($DATE_PUB);
...
function qualification_system_OldStyle($xml)
 {
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            $town = $ml_ti->TI_TOWN;
            $htmlData .= "<tr><td style='font-weight: bold;'>ML_TI_DOC</td><td>" . $ml_ti->TI_TEXT->P . "</td></tr>";
        }
    }
...
function contract_nature($xml) {
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
         if ($ml_ti['LG'] == 'EN') {
            ...
            if (!empty($ml_ti->TI_TEXT->P->P)) {
                $ti_text = $ml_ti->TI_TEXT->P->P;
            } else {
                $ti_text = $ml_ti->TI_TEXT->P;
            }

            $htmlData .= "<tr><td style='font-weight: bold;'>ML_TI_DOC</td><td>" . $ti_text . "</td></tr>";
        }
    }

    $aa_name = "";
    foreach ($xml->TRANSLATION_SECTION->ML_AA_NAMES->AA_NAME as $ml_aa_name) {
        if ($ml_aa_name['LG'] == 'EN') {
            $aa_name = $ml_aa_name;
            break;
        } else {
    ...
    //echo $htmlData;
    foreach ($xml->FORM_SECTION->F02_2014 as $temp) {
        if ($temp["LG"] == 'EN') {
            $data = $temp;
        }
    }
    if (empty($data)) {
        $data = $xml->FORM_SECTION->F02_2014;
    }
    ...
    if (empty($data)) {
        ...
        foreach ($xml->FORM_SECTION as $child) {
        ...
        $data = $xml->FORM_SECTION->$key_name;
    }
    ...
    if ($data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->OFFICIALNAME) {
        $official_name = $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->OFFICIALNAME;
    } else {
        $official_name = $aa_name;
    }

echo $xml['DOC_ID'];
    
     if (!empty($xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE)) 
         {
         $htmlData .='
	...
	<tr>
	<td style="font-weight: bold;">ADDRESS</td>
	<td>' . $xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->ADDRESS . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">POSTAL_CODE</td>
	<td>' . $xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->POSTAL_CODE . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">CONTACT_POINT</td>
	<td>' . $xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->CONTACT_POINT . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">ATTENTION</td>
	<td>' . $xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->ATTENTION . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">PHONE</td>
	<td>' . $xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->PHONE . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">E_MAIL</td>
	<td>' . $xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->E_MAILS->E_MAIL . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">FAX</td>
	<td>' . $xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->FAX . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">LG</td>
	<td>' . $xml["LG"] . '</td>
	...
	<td style="font-weight: bold;">COUNTRY</td>
	<td>';
    $country = $xml->FORM_SECTION->CONTRACT_DEFENCE->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->COUNTRY["VALUE"];
	...
	<tr>
	<td style="font-weight: bold;">ADDRESS</td>
	<td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->ADDRESS . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">POSTAL_CODE</td>
	<td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->POSTAL_CODE . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">CONTACT_POINT</td>
	<td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->CONTACT_POINT . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">ATTENTION</td>
	<td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->ATTENTION . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">PHONE</td>
	<td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->PHONE . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">E_MAIL</td>
	<td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->E_MAIL . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">FAX</td>
	<td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->FAX . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">LG</td>
	<td>' . $data["LG"] . '</td>
	...
	<td style="font-weight: bold;">COUNTRY</td>
	<td>';
    $country = $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->COUNTRY["VALUE"];
	...
	<tr>
	<td style="font-weight: bold;">CPV_CODE</td>
	<td>' . $data->OBJECT_CONTRACT->CPV_MAIN->CPV_CODE["CODE"];

    foreach ($data->OBJECT_CONTRACT->OBJECT_DESCR->CPV_ADDITIONAL as $cpv_ad) {
        $htmlData .= "," . $cpv_ad->CPV_CODE['CODE'];
    }

    foreach ($xml->CODED_DATA_SECTION->NOTICE_DATA->ORIGINAL_CPV as $org_cpv_ad) {
        $htmlData .= "," . $org_cpv_ad['CODE'];
    }
	...
	<tr>
	<td style="font-weight: bold;">NUTS</td>
	<td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->NUTS["CODE"] . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">IA_URL_GENERAL</td>
	<td>' . $xml->CODED_DATA_SECTION->NOTICE_DATA->IA_URL_GENERAL . '</td>
    ...
    if (!empty($data->OBJECT_CONTRACT->TITLE->P)) {
        $htmlData .= $data->OBJECT_CONTRACT->TITLE->P . "<br/>";
    }

    if (!empty($data->OBJECT_CONTRACT->REFERENCE_NUMBER)) {
        $htmlData .= "Reference Number : " . $data->OBJECT_CONTRACT->REFERENCE_NUMBER . "<br/>";
    }

    if (!empty($data->OBJECT_CONTRACT->SHORT_DESCR->P)) {
        $htmlData .= $data->OBJECT_CONTRACT->SHORT_DESCR->P . "<br/>";
    }


    if (!empty($data->OBJECT_CONTRACT->OBJECT_DESCR->NUTS["CODE"])) {
        $htmlData .= "NUTS Code : " . $data->OBJECT_CONTRACT->OBJECT_DESCR->NUTS["CODE"] . "<br/>";
    }

    if (!empty($data->OBJECT_CONTRACT->OBJECT_DESCR->MAIN_SITE->P)) {
        $htmlData .= "Main Site : " . $data->OBJECT_CONTRACT->OBJECT_DESCR->MAIN_SITE->P . "<br/>";
    }

    foreach ($data->OBJECT_CONTRACT->OBJECT_DESCR->SHORT_DESCR->P as $short_descp) {
        $htmlData .= $short_descp . "<br/>";
    }

    foreach ($data->LEFTI->SUITABILITY->P as $suitable_p) {
        $htmlData .= $suitable_p . "<br/>";
    }

    foreach ($data->LEFTI->ECONOMIC_FINANCIAL_INFO->P as $financial_info) {
        $htmlData .= $financial_info . "<br/>";
    }


    foreach ($data->COMPLEMENTARY_INFO->INFO_ADD->P as $complementry_info) {
        $htmlData .= $complementry_info . "<br/>";
    }
...
//    }
    ...
    $flag_required = "2";
    if (!empty($ti_text) && !empty($country) && !empty($official_name) && !empty($newDate)) {

        $flag_required = "1";
    }

    return $htmlData . "<!>" . $flag_required;
}


function Dynamic_purchasing_system_4_all($xml) 
{
    $htmlData = '<html><head><meta charset="UTF-8"></head><body><table border="1">';
    $htmlData .='
	<tr>
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            ...
            if ($ml_ti->TI_TEXT->P->P) {
                $ml_ti_shoertdescp = $ml_ti->TI_TEXT->P->P;
            } else {
                $ml_ti_shoertdescp = $ml_ti->TI_TEXT->P;
            }

            $htmlData .= "<tr><td style='font-weight: bold;'>ML_TI_DOC</td><td>" . $ml_ti_shoertdescp . "</td></tr>";
        }
    }
    //echo $htmlData;
    foreach ($xml->FORM_SECTION->F02_2014 as $temp) {
    ...
    if ($data->FD_CONTRACT->CONTRACTING_AUTHORITY_INFORMATION->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME) {
        $official_name = $data->FD_CONTRACT->CONTRACTING_AUTHORITY_INFORMATION->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME;
    } else {
        $official_name = $aa_name;
    }
    ...
    if (!empty($data->FD_CONTRACT->OBJECT_CONTRACT_INFORMATION->DESCRIPTION_CONTRACT_INFORMATION->TITLE_CONTRACT->P)) {
        $htmlData .= $data->FD_CONTRACT->OBJECT_CONTRACT_INFORMATION->DESCRIPTION_CONTRACT_INFORMATION->TITLE_CONTRACT->P . "<br/>";
    }
    ...
    foreach ($data->FD_CONTRACT->OBJECT_CONTRACT_INFORMATION->DESCRIPTION_CONTRACT_INFORMATION->SHORT_CONTRACT_DESCRIPTION->P as $shortdecp_p) {
        $htmlData .= $shortdecp_p . "<br/>";
    }



    foreach ($data->FD_CONTRACT->LEFTI_CONTRACT->CONTRACT_RELATING_CONDITIONS->DEPOSITS_GUARANTEES_REQUIRED->P as $suitable_p) {
        $htmlData .= $suitable_p . "<br/>";
    }

    foreach ($data->FD_CONTRACT->LEFTI_CONTRACT->CONTRACT_RELATING_CONDITIONS->MAIN_FINANCING_CONDITIONS->P as $financial_info) {
        $htmlData .= $financial_info . "<br/>";
    }


    foreach ($data->FD_CONTRACT->LEFTI_CONTRACT->F02_CONDITIONS_FOR_PARTICIPATION->ECONOMIC_OPERATORS_PERSONAL_SITUATION->P as $complementry_info) {
        $htmlData .= $complementry_info . "<br/>";
    }
...
//    }
    ...
    $flag_required = "2";
    if (!empty($ml_ti_shoertdescp) && !empty($country) && !empty($official_name) && !empty($newDate)) {
...
function defence($xml) {
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            ...
            if ($ml_ti->TI_TEXT->P->P) {
                $ml_ti_shortDescp = $ml_ti->TI_TEXT->P->P;
            } else {
                $ml_ti_shortDescp = $ml_ti->TI_TEXT->P;
            }


            $htmlData .= "<tr><td style='font-weight: bold;'>ML_TI_DOC</td><td>" . $ml_ti_shortDescp . "</td></tr>";
        }
    }
    //echo $htmlData;
    ...
    if ($data->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME) {
        $official_name = $data->FD_CONTRACT_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME;
    } else {
        $official_name = $aa_name;
    }
...
function utilities($xml) {
    ...
    if ($data->FD_CONTRACT_UTILITIES->CONTRACTING_AUTHORITY_INFO->NAME_ADDRESSES_CONTACT_CONTRACT_UTILITIES->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME) {
        $official_name = $data->FD_CONTRACT_UTILITIES->CONTRACTING_AUTHORITY_INFO->NAME_ADDRESSES_CONTACT_CONTRACT_UTILITIES->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME;
    } else {
        $official_name = $aa_name;
    }
    ...
    $htmlData .= $data->FD_CONTRACT_UTILITIES->OBJECT_CONTRACT_INFORMATION_CONTRACT_UTILITIES->CONTRACT_OBJECT_DESCRIPTION->SHORT_CONTRACT_DESCRIPTION->P;
    $htmlData .= '</td></tr>
	<tr>
	<td style="font-weight: bold;">SHORT_DESCRIPTION</td>
	<td>' . $ml_ti_shoertdescp . '</td>
	</tr>
	</table></body></html>';
...
function design_contest($xml) {
    ...
    //DESIGN_CONTEST with F12_2014
    //echo $htmlData;
    //foreach ($xml->FORM_SECTION->DESIGN_CONTEST as $temp) {
    foreach ($xml->FORM_SECTION->F12_2014 as $temp) {    
        if ($temp["LG"] == 'EN') {
            $data = $temp;
        }
    }
    if (empty($data)) {
        $data = $xml->FORM_SECTION->F12_2014;
    }
    if (empty($xml->CODED_DATA_SECTION->CODIF_DATA->DT_DATE_FOR_SUBMISSION)) {
        $Date = YmdChnage($xml->CODED_DATA_SECTION->REF_OJS->DATE_PUB);
        $newDate = date("Y-m-d", strtotime(date("Y-m-d", strtotime($Date)) . " + 1 year"));
   ...
   // print_r($xml);
	...
	<tr>
	<td style="font-weight: bold;">OFFICIALNAME</td>
            <td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->OFFICIALNAME . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">ADDRESS</td>
            <td>' . $data->CONTRACTING_BODY->ADDRESS_CONTRACTING_BODY->ADDRESS . '</td>
   ...
   // $country = $data->FD_DESIGN_CONTEST->AUTHORITY_ENTITY_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->COUNTRY["VALUE"];
	...
	<tr>
	<td style="font-weight: bold;">SHORT_DESCRIPTION</td>
	<td>' . $data->OBJECT_CONTRACT->OBJECT_DESCR->SHORT_DESCR->P . '</td>
	</tr>
	</table></body></html>';
    return $htmlData;
    //echo $htmlData;
...
function qualification_system_with($xml) {
    ...
    if (empty($data)) {
        $data = $xml->FORM_SECTION->F07_2014;//QUALIFICATION_SYSTEM_UTILITIES;
    }
    if (empty($data)) {
        $data = $xml->FORM_SECTION->QUALIFICATION_SYSTEM_UTILITIES;
    }
	...
	<td style="font-weight: bold;">CPV_CODE</td>
	<td>' . $data->OBJECT_CONTRACT->CPV_MAIN->CPV_CODE["CODE"];
    foreach ($data->OBJECT_CONTRACT->CPV_ADDITIONAL as $cpv_ad)
        $htmlData .= "," . $cpv_ad->CPV_CODE['CODE'];
    $htmlData .='
	</td>
	</tr>
	...
	<td style="font-weight: bold;">SHORT_DESCRIPTION</td>
	<td>';
    foreach ($data->OBJECT_CONTRACT->OBJECT_DESCR->SHORT_DESCR->P as $shrtDesc) {
        $htmlData .="$shrtDesc<br/>";
    }
    $htmlData .='</td></tr>
	</table></body></html>';
...
function call_expressions_interest($xml) {
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            ...
            if (!empty($ml_ti->TI_TEXT->P->P)) {
                $new_short_descp = $ml_ti->TI_TEXT->P->P;
            } else {
                $new_short_descp = $ml_ti->TI_TEXT->P;
            }



            $htmlData .= "<tr><td style='font-weight: bold;'>ML_TI_DOC</td><td>" . $new_short_descp . "</td></tr>";
        }
    }
    //echo $htmlData;
    ...
    $puchaser_name = $data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->ORGANISATION;
    $purchaser_address = $data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->ADDRESS;
    $purchaser_postalcode = $data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->POSTAL_CODE;
    $purchaser_contactpoint = $data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->CONTACT_POINT;
    $purchaser_attention = $data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->ATTENTION;
    $purchaser_phone = $data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->PHONE;
    $purchaser_email = $data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->E_MAIL;
    $purchaser_fax = $data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->FAX;

    if (empty($puchaser_name)) {
        $puchaser_name = $data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->ORGANISATION;

        $purchaser_address = $data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->ADDRESS;
        $purchaser_postalcode = $data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->POSTAL_CODE;
        $purchaser_contactpoint = $data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->CONTACT_POINT;
        $purchaser_attention = $data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->ATTENTION;
        $purchaser_phone = $data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->PHONE;

        $purchaser_email = $data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->E_MAIL;
        $purchaser_fax = $data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR->TXT_MARK->P->ADDRESS_NOT_STRUCT->FAX;
    }

    if (empty($puchaser_name)) {
        $puchaser_name = $data->FD_OTH_NOT->CONTENTS->P->ADDRESS_NOT_STRUCT->ORGANISATION;
        $purchaser_address = $data->FD_OTH_NOT->CONTENTS->P->ADDRESS_NOT_STRUCT->ADDRESS;
        $purchaser_postalcode = $data->FD_OTH_NOT->CONTENTS->P->ADDRESS_NOT_STRUCT->POSTAL_CODE;
        $purchaser_contactpoint = $data->FD_OTH_NOT->CONTENTS->P->ADDRESS_NOT_STRUCT->CONTACT_POINT;
        $purchaser_attention = $data->FD_OTH_NOT->CONTENTS->P->ADDRESS_NOT_STRUCT->ATTENTION;
        $purchaser_phone = $data->FD_OTH_NOT->CONTENTS->P->ADDRESS_NOT_STRUCT->PHONE;
        $purchaser_email = $data->FD_OTH_NOT->CONTENTS->P->ADDRESS_NOT_STRUCT->E_MAIL;
        $purchaser_fax = $data->FD_OTH_NOT->CONTENTS->P->ADDRESS_NOT_STRUCT->FAX;
    }

    if (empty($puchaser_name)) {
        foreach ($data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR as $mli_occur) {
            $puchaser_name = $mli_occur->TXT_MARK->P->ADDRESS_NOT_STRUCT->ORGANISATION;

            $purchaser_address = $mli_occur->TXT_MARK->P->ADDRESS_NOT_STRUCT->ADDRESS;
            $purchaser_postalcode = $mli_occur->TXT_MARK->P->ADDRESS_NOT_STRUCT->POSTAL_CODE;
            $purchaser_contactpoint = $mli_occur->TXT_MARK->P->ADDRESS_NOT_STRUCT->CONTACT_POINT;
            $purchaser_attention = $mli_occur->TXT_MARK->P->ADDRESS_NOT_STRUCT->ATTENTION;
            $purchaser_phone = $mli_occur->TXT_MARK->P->ADDRESS_NOT_STRUCT->PHONE;
            $purchaser_email = $mli_occur->TXT_MARK->P->ADDRESS_NOT_STRUCT->E_MAIL;
            $purchaser_fax = $mli_occur->TXT_MARK->P->ADDRESS_NOT_STRUCT->FAX;
    ...
    if (empty($puchaser_name)) {
        foreach ($data->FD_OTH_NOT->CONTENTS->MARK_LIST->MLI_OCCUR as $mli_occur_t) {
            $puchaser_name = $mli_occur_t->TXT_MARK->P->ADDRESS_NOT_STRUCT->ORGANISATION;

            $purchaser_address = $mli_occur_t->TXT_MARK->P->ADDRESS_NOT_STRUCT->ADDRESS;
            $purchaser_postalcode = $mli_occur_t->TXT_MARK->P->ADDRESS_NOT_STRUCT->POSTAL_CODE;
            $purchaser_contactpoint = $mli_occur_t->TXT_MARK->P->ADDRESS_NOT_STRUCT->CONTACT_POINT;
            $purchaser_attention = $mli_occur_t->TXT_MARK->P->ADDRESS_NOT_STRUCT->ATTENTION;
            $purchaser_phone = $mli_occur_t->TXT_MARK->P->ADDRESS_NOT_STRUCT->PHONE;
            $purchaser_email = $mli_occur_t->TXT_MARK->P->ADDRESS_NOT_STRUCT->E_MAIL;
            $purchaser_fax = $mli_occur_t->TXT_MARK->P->ADDRESS_NOT_STRUCT->FAX;
    ...
    if (empty($puchaser_name)) {
        foreach ($data->FD_OTH_NOT->CONTENTS->P as $mli_content) {
            $puchaser_name = $mli_content->ADDRESS_NOT_STRUCT->ORGANISATION;
            $purchaser_address = $mli_content->ADDRESS_NOT_STRUCT->ADDRESS;
            $purchaser_postalcode = $mli_content->ADDRESS_NOT_STRUCT->POSTAL_CODE;
            $purchaser_contactpoint = $mli_content->ADDRESS_NOT_STRUCT->CONTACT_POINT;
            $purchaser_attention = $mli_content->ADDRESS_NOT_STRUCT->ATTENTION;
            $purchaser_phone = $mli_content->ADDRESS_NOT_STRUCT->PHONE;
            $purchaser_email = $mli_content->ADDRESS_NOT_STRUCT->E_MAIL;
            $purchaser_fax = $mli_content->ADDRESS_NOT_STRUCT->FAX;
	...
	<tr>
	<td style="font-weight: bold;">ADDRESS</td>
	<td>' . $purchaser_address . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">POSTAL_CODE</td>
	<td>' . $purchaser_postalcode . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">CONTACT_POINT</td>
	<td>' . $purchaser_contactpoint . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">ATTENTION</td>
	<td>' . $purchaser_attention . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">PHONE</td>
	<td>' . $purchaser_phone . '</td>
	</tr>
	<tr>
	<td style="font-weight: bold;">E_MAIL</td>
    ...
    foreach ($xml->CODED_DATA_SECTION->NOTICE_DATA->ORIGINAL_CPV as $org_cpv) {
        if (!empty($org_cpv["CODE"]) && is_numeric(substr($org_cpv["CODE"], 0, 8))) {
            $htmlData .= substr($org_cpv["CODE"], 0, 8) . ",";
        }
    }
    $htmlData .='
	</td>
    ...
    foreach ($data->FD_OTH_NOT->CONTENTS->P as $cotent_p) {
        $htmlData .= $cotent_p . ".<br/>";
    }

    foreach ($data->FD_OTH_NOT->CONTENTS->GR_SEQ->BLK_BTX_SEQ->MARK_LIST->MLI_OCCUR as $occur_p) {

        foreach ($occur_p->TXT_MARK->P as $ocontact_p) {
            $htmlData .= $ocontact_p . ".<br/>";
        }
    }
	...
	<tr>
	<td style="font-weight: bold;">SHORT_DESCRIPTION</td>
	<td>' . $new_short_descp . '</td>
	</tr>
	</table></body></html>';


    $flag_required = "2";
    if (!empty($new_short_descp) && !empty($country) && !empty($puchaser_name) && !empty($newDate) && !empty($purchaser_email)) {
...
function simplefied_interest($xml) {
    ...
    if ($data->FD_SIMPLIFIED_CONTRACT->AUTHORITY_ENTITY_SIMPLIFIED_CONTRACT_NOTICE->NAME_ADDRESSES_CONTACT_SIMPLIFIED_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME) {
        $official_name = $data->FD_SIMPLIFIED_CONTRACT->AUTHORITY_ENTITY_SIMPLIFIED_CONTRACT_NOTICE->NAME_ADDRESSES_CONTACT_SIMPLIFIED_CONTRACT->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME;
    } else {
        $official_name = $aa_name;
    }
...
function prior_info_move($xml) {
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            $town = $ml_ti->TI_TOWN;
            if ($ml_ti->TI_TEXT->P->P) {
                $ml_ti_Descp = $ml_ti->TI_TEXT->P->P;
            } else {
                $ml_ti_Descp = $ml_ti->TI_TEXT->P;
            }
            $htmlData .= "<tr><td style='font-weight: bold;'>ML_TI_DOC</td><td>" . $ml_ti_Descp . "</td></tr>";
        }
    }
    //echo $htmlData;
    ...
    if ($data->FD_PRIOR_INFORMATION_MOVE->AUTHORITY_PI_MOVE->NAME_ADDRESSES_CONTACT_MOVE->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME) {
        $official_name = $data->FD_PRIOR_INFORMATION_MOVE->AUTHORITY_PI_MOVE->NAME_ADDRESSES_CONTACT_MOVE->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME;
    } else {
        $official_name = $aa_name;
    }
	...
	<td style="font-weight: bold;">SHORT_DESCRIPTION</td>
	<td>';
    $htmlData .= $ml_ti_Descp;
    $htmlData .='</td></tr>
	</table></body></html>';


    $flag_required = "2";
    if (!empty($ml_ti_Descp) && !empty($country) && !empty($official_name) && !empty($newDate)) {
...
//CA --Done
function contract_awardNew($xml, $db2 = NULL, $db2 = NULL) {
    ...
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            $short_descp = str_replace("'", "\'", $ml_ti->TI_TEXT->P);

            // News
            $news_txt = str_replace("'", "\'", $ml_ti->TI_TEXT->P);
...
//    }
    ...
    foreach ($AWARD_OF_CONTRACT as $AWARD) {
        ...
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>Telephone: " . $AWARD->ECONOMIC_OPERATOR_NAME_ADDRESS->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->PHONE . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>Internet address: " . $AWARD->ECONOMIC_OPERATOR_NAME_ADDRESS->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->URL . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>Fax: " . $AWARD->ECONOMIC_OPERATOR_NAME_ADDRESS->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->FAX . "</p>";
    ...
    $news_details_main = addslashes(trim($news_details_main));
    ...
    $source_url = $xml->CODED_DATA_SECTION->NOTICE_DATA->URI_LIST->URI_DOC;
     ...
     //New ShortDesc Condition 29Aug2017
     $contracttype = str_replace("'", "\'", $xml->CODED_DATA_SECTION->CODIF_DATA->NC_CONTRACT_NATURE);
       $news_cynews_town = $news_cur_city . "-" . $news_cur_town ;
    if(!empty($short_descp))
    {
      //$NewShortdesc = $short_descp +" - "+  +", "+ $news_cy+"-"+$news_town +","+$ref_number;
      $NewShortdesc = $short_descp ."-". $contracttype .", ". $news_cynews_town.", Ref No:". $news_NO_DOC_OJS;
    }
    if(empty($NewShortdesc))
    {
        $NewShortdesc = $short_descp;
    }
    ...
    $NewsData_Arr = array(
     ...
     $contData = array(
        "short_descp" =>  "'$NewShortdesc'",//  "'$short_descp'",
...
//    }
   ...
   try {
    $news_details = $award_detail . "<br/>" . $news_purchaser_details . "<br/>" . $news_contractor_details . "<br/>" .
            $news_reception_id . "<br/>" . $news_DELETION_DATE . "<br/>" . $news_lang_avl . "<br/>" . $news_contract_type . "<br/>" .
            $news_directive_value . "<br/>" . $news_cpv . "<br/>" . $news_ref_num . "<br/>" . $news_notice_data . "<br/>" .
            $news_codifdata . "<br/>" . "<b>Additional Information: </b>" . "<br/>" . $news_form_values_complete;
             //$news_codifdata . "<br/>" .$news_form_values_complete;
     //$news_codifdata . "<br/>" . $news_additioal_info . "<br/>" . $news_form_values_complete;
    } catch (Exception $exc) {
        echo $exc->getTraceAsString();
    }
    $source_url = $xml->CODED_DATA_SECTION->NOTICE_DATA->URI_LIST->URI_DOC;
   // $news_cynews_town = $news_cy . "-" . $news_town ;
    ...
    $NO_DOC_OJS = $xml->NOTICE_DATA->NO_DOC_OJS;
    $contData = array(
        "short_descp" =>  "'$NewShortdesc'",//  "'$short_descp'",
        "ref_number" => "'$ref_number'",
        "purchasername" => "'$purchasername'",
...
function contract_award_utili($xml, $db2 = NULL, $db2 = NULL) {
  ...
  $contData = array(
        ...
        "cont_url" => "'$cont_url'",
        "project_location" => "'$project_location'",
        "award_detail" =>  "'$news_details'",  // "'$award_detail'",
        "contract_val" => "'$contract_val'",
        "contract_currency" => "'$contract_currency'",
        "sector" => "'$seccode'",
        "cont_date" => "'$cont_date'",
...
function contract_award_defence($xml, $db2 = NULL, $db2 = NULL) {
    ...
    $CODED_DATA_SECTION = $xml->CODED_DATA_SECTION;
    $LG_ORIG = (array) $CODED_DATA_SECTION->NOTICE_DATA->LG_ORIG;
    $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE = $FORM_SECTION->FD_CONTRACT_AWARD_DEFENCE->CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE;
    $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE_DEFENCE = $FORM_SECTION->FD_CONTRACT_AWARD_DEFENCE->PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE_DEFENCE;
    $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE = $FORM_SECTION->FD_CONTRACT_AWARD_DEFENCE->OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE;
    $AWARD_OF_CONTRACT_DEFENCE = $FORM_SECTION->FD_CONTRACT_AWARD_DEFENCE->AWARD_OF_CONTRACT_DEFENCE;
    $COMPLEMENTARY_INFORMATION_CONTRACT_AWARD = $FORM_SECTION->FD_CONTRACT_AWARD_DEFENCE->COMPLEMENTARY_INFORMATION_CONTRACT_AWARD;
    ...
    $CRITERIA_DEFINITION_VAL = '';
    foreach ($PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE_DEFENCE->AWARD_CRITERIA_CONTRACT_AWARD_NOTICE_INFORMATION_DEFENCE->AWARD_CRITERIA_DETAIL_F18->MOST_ECONOMICALLY_ADVANTAGEOUS_TENDER_SHORT->CRITERIA_DEFINITION as $CRITERIA_DEFINITION) {
        $CRITERIA_DEFINITION_VAL .= "<p>" . $CRITERIA_DEFINITION->ORDER_C . ". " . $CRITERIA_DEFINITION->CRITERIA . " Weighting " . $CRITERIA_DEFINITION->WEIGHTING . "</p>";
    }

    $SHORT_CONTRACT_DESCRIPTION = '';
    foreach ($OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE->DESCRIPTION_AWARD_NOTICE_INFORMATION_DEFENCE->SHORT_CONTRACT_DESCRIPTION->P as $pVal) {
        $SHORT_CONTRACT_DESCRIPTION .= "<p>" . $pVal . "</p>";
    }

    $AWARD_OF_CONTRACT_VAL = '';
    foreach ($AWARD_OF_CONTRACT_DEFENCE as $AWARD) {
        $AWARD_OF_CONTRACT_VAL .= "<p>Contract No: " . $AWARD->CONTRACT_NUMBER . " Lot No: " . $AWARD->LOT_NUMBER . " - Lot title: " . $AWARD->CONTRACT_TITLE->P . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<div style='margin-left: 2em;'>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='font-weight: bold;'>V.1) Date of contract award decision:</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>" . $AWARD->CONTRACT_AWARD_DATE->DAY . "." . $AWARD->CONTRACT_AWARD_DATE->MONTH . "." . $AWARD->CONTRACT_AWARD_DATE->YEAR . "</p>";
    ...
    $newsDetails_cur = "
        ...
        <span> Directive : $Directive</span>
            ...
            <div style='margin-left: 1em;'>
                <p style='font-weight: bold;'>I.1) Name, addresses and contact point(s)</p>
                <div style='margin-left: 2em;'>
                    <p>" . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME . "</p>
                    <p>" . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->ADDRESS . "</p>
                    <p>For the attention of: " . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->ATTENTION . "</p>
                    <p>Contact point(s): " . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->CONTACT_POINT . "</p>
                    <p>" . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->POSTAL_CODE . " " . $news_cur_town . "</p>
                    <p>$news_cur_city</p>
                    <p>Telephone : " . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->PHONE . "</p>
                    <p>E-mail: " . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->E_MAILS->E_MAIL . "</p>
                    <p>Fax : " . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->CA_CE_CONCESSIONAIRE_PROFILE->FAX . "</p>
                    <p style='font-weight: bold;'>Internet address(es):<p>
                    <p>General address of the contracting entity: <a target='_blank' href='http://" . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->INTERNET_ADDRESSES_CONTRACT_AWARD->URL_GENERAL . "'>" . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD_DEFENCE->NAME_ADDRESSES_CONTACT_CONTRACT_AWARD->INTERNET_ADDRESSES_CONTRACT_AWARD->URL_GENERAL . "</a></p>
                </div>
                <p style='font-weight: bold;'>I.2) Type of the contracting authority</p>
                <p>" . $CODED_DATA_SECTION->CODIF_DATA->RP_REGULATION . "</p>
                <p style='font-weight: bold;'>I.3) Main activity</p>
                <p>" . $CONTRACTING_AUTHORITY_INFORMATION_CONTRACT_AWARD->TYPE_AND_ACTIVITIES_AND_PURCHASING_ON_BEHALF->TYPE_AND_ACTIVITIES->TYPE_OF_ACTIVITY_OTHER . "</p>
                <p style='font-weight: bold;'>I.4) Contract award on behalf of other contracting entities</p>
                <p>The contracting authority is purchasing on behalf of other contracting authorities: " . $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE_DEFENCE->AWARD_CRITERIA_CONTRACT_AWARD_NOTICE_INFORMATION->F03_IS_ELECTRONIC_AUCTION_USABLE['VALUE'] . "</p>
            </div>
            ...
            <div style='margin-left: 1em;'>
                <p style='font-weight: bold;'>II.1) Description</p>
                <p style='font-weight: bold;'>II.1.1) Title attributed to the contract</p>
                <p>" . $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE->DESCRIPTION_AWARD_NOTICE_INFORMATION_DEFENCE->TITLE_CONTRACT->P . "</p>
                <p style='font-weight: bold;'>II.1.2) Type of contract and location of works, place of delivery or of performance</p>
                <p>" . $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE->DESCRIPTION_AWARD_NOTICE_INFORMATION_DEFENCE->TYPE_CONTRACT_W_PUB_DEFENCE->TYPE_CONTRACT['VALUE'] . "</p>
                <p>" . $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE->DESCRIPTION_AWARD_NOTICE_INFORMATION_DEFENCE->TYPE_CONTRACT_W_PUB_DEFENCE->TYPE_SUPPLIES_CONTRACT['VALUE'] . "</p>
                <p>Main site or location of works, place of delivery or of performance: " . $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE->DESCRIPTION_AWARD_NOTICE_INFORMATION_DEFENCE->LOCATION_NUTS->LOCATION->P . "</p>
                <p style='font-weight: bold;'>II.1.3) Information about a framework agreement or a dynamic purchasing system (DPS)</p>
                <p style='font-weight: bold;'>II.1.4) Short description of the contract or purchase(s):</p>
                <p>" . $SHORT_CONTRACT_DESCRIPTION . "</p>
                <p style='font-weight: bold;'>II.1.5) Common procurement vocabulary (CPV)</p>
                ...
                <p>$ORIGINAL_CPV</p>
                <p style='font-weight: bold;'>II.1.6) Information about Government Procurement Agreement (GPA)</p>
                <p>The contract is covered by the Government Procurement Agreement (GPA): " . $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE->DESCRIPTION_AWARD_NOTICE_INFORMATION_DEFENCE->CONTRACT_COVERED_GPA['VALUE'] . "</p>
                <p style='font-weight: bold;'>II.2) Total final value of contract(s)</p>
                <p style='font-weight: bold;'>II.2.1) Total final value of contract(s)</p>
                <p>Value : " . $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE_DEFENCE->TOTAL_FINAL_VALUE->COSTS_RANGE_AND_CURRENCY_WITH_VAT_RATE->VALUE_COST . " " . $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE->TOTAL_FINAL_VALUE->COSTS_RANGE_AND_CURRENCY_WITH_VAT_RATE['CURRENCY'] . "</p>
            </div>
            ...
            <div style='margin-left: 1em;'>
                ...
                <p>" . $CRITERIA_DEFINITION_VAL . "</p>
                <p style='font-weight: bold;'>IV.2.2) Information about electronic auction</p>
                <p>An electronic auction has been used : " . $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE_DEFENCE->AWARD_CRITERIA_CONTRACT_AWARD_NOTICE_INFORMATION_DEFENCE->F18_IS_ELECTRONIC_AUCTION_USABLE['VALUE'] . "</p>
                <p style='font-weight: bold;'>IV.3) Administrative information</p>
                <p style='font-weight: bold;'>IV.3.1) File reference number attributed by the contracting entity:</p>
                <p>" . $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE_DEFENCE->ADMINISTRATIVE_INFORMATION_CONTRACT_AWARD_DEFENCE->FILE_REFERENCE_NUMBER->P . "</p>
                <p style='font-weight: bold;'>IV.3.2) Previous publication(s) concerning the same contract</p>
                <p>Notice number in the OJEU: " . $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE->ADMINISTRATIVE_INFORMATION_CONTRACT_AWARD->PREVIOUS_PUBLICATION_INFORMATION_NOTICE_F3->PREVIOUS_PUBLICATION_EXISTS_F3->CNT_NOTICE_INFORMATION->NOTICE_NUMBER_OJ . " of " . $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE->ADMINISTRATIVE_INFORMATION_CONTRACT_AWARD->PREVIOUS_PUBLICATION_INFORMATION_NOTICE_F3->PREVIOUS_PUBLICATION_EXISTS_F3->CNT_NOTICE_INFORMATION->DATE_OJ->DAY . "." . $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE->ADMINISTRATIVE_INFORMATION_CONTRACT_AWARD->PREVIOUS_PUBLICATION_INFORMATION_NOTICE_F3->PREVIOUS_PUBLICATION_EXISTS_F3->CNT_NOTICE_INFORMATION->DATE_OJ->MONTH . "." . $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE->ADMINISTRATIVE_INFORMATION_CONTRACT_AWARD->PREVIOUS_PUBLICATION_INFORMATION_NOTICE_F3->PREVIOUS_PUBLICATION_EXISTS_F3->CNT_NOTICE_INFORMATION->DATE_OJ->YEAR . "</p>
            </div>
...
function result_design_contest($xml, $db2 = NULL, $db2 = NULL) {
    ...
    $CODED_DATA_SECTION = $xml->CODED_DATA_SECTION;
    $LG_ORIG = (array) $CODED_DATA_SECTION->NOTICE_DATA->LG_ORIG;
    $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST = $FORM_SECTION->FD_RESULT_DESIGN_CONTEST->CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST;
    $PROCEDURES_RESULT_DESIGN_CONTEST = $FORM_SECTION->FD_RESULT_DESIGN_CONTEST->PROCEDURES_RESULT_DESIGN_CONTEST;
    $OBJECT_RESULT_DESIGN_CONTEST = $FORM_SECTION->FD_RESULT_DESIGN_CONTEST->OBJECT_RESULT_DESIGN_CONTEST;
    $RESULT_CONTEST = $FORM_SECTION->FD_RESULT_DESIGN_CONTEST->RESULTS_CONTEST_RESULT_DESIGN_CONTEST->RESULT_CONTEST;
    $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST = $FORM_SECTION->FD_RESULT_DESIGN_CONTEST->COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST;
    ...
    $SHORT_CONTRACT_DESCRIPTION = '';
    foreach ($OBJECT_RESULT_DESIGN_CONTEST->DESCRIPTION->P as $pVal) {
        $SHORT_CONTRACT_DESCRIPTION .= "<p>" . $pVal . "</p>";
    }

    $AWARD_OF_CONTRACT_VAL = '';
    foreach ($RESULT_CONTEST as $AWARD) {
        $AWARD_OF_CONTRACT_VAL .= "<p>No: " . $AWARD->CONTEST_NUMBER . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p>" . $AWARD->CONTEST_TITLE->P . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<div style='margin-left: 2em;'>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='font-weight: bold;'>V.1) Award and prizes</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='font-weight: bold;'>V.1.1) Number of participants:</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>" . $AWARD->AWARD_PRIZES->PARTICIPANTS_NUMBER . "</p>";

        $AWARD_OF_CONTRACT_VAL .= "<p style='font-weight: bold;'>V.1.2) Number of foreign participants:</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>" . $AWARD->AWARD_PRIZES->FOREIGN_PARTICIPANTS_NUMBER . "</p>";

        $AWARD_OF_CONTRACT_VAL .= "<p style='font-weight: bold;'>V.3) Name(s) and address(es) of the winner(s) of the contest</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>" . $AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->ORGANISATION->OFFICIALNAME . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>" . $AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->ADDRESS . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>" . $AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->POSTAL_CODE . " " . $AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->TOWN . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>" . getCountryName($AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->COUNTRY['VALUE']) . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>E-mail: " . $AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->E_MAILS->E_MAIL . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>Telephone: " . $AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->PHONE . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>Internet address: " . $AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->URL . "</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>Fax: " . $AWARD->AWARD_PRIZES->NAME_ADDRESS_WINNER->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->FAX . "</p>";

        $AWARD_OF_CONTRACT_VAL .= "<p style='font-weight: bold;'>V.4) Value of the prize(s)</p>";
        $AWARD_OF_CONTRACT_VAL .= "<p style='margin-left: 1em;'>Fax: " . $AWARD->PRIZE_VALUE . "</p>";

        $AWARD_OF_CONTRACT_VAL .= "</div>";
    }
    $ADDITIONAL_INFORMATION_ARR = '';
    foreach ($COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->ADDITIONAL_INFORMATION->P as $ADDITIONAL_INFORMATION) {
        $ADDITIONAL_INFORMATION_ARR .= "<span style='  line-height: 1.2;'>$ADDITIONAL_INFORMATION</span><br/>";
    }
    ...
    $newsDetails_cur = "
        ...
        <span> Directive : $Directive</span>
            ...
            <div style='margin-left: 1em;'>
                <p style='font-weight: bold;'>I.1) Name, addresses and contact point(s)</p>
                <div style='margin-left: 2em;'>
                    <p>" . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->ORGANISATION->OFFICIALNAME . "</p>
                    <p>" . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->ADDRESS . "</p>
                    <p>For the attention of: " . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->ATTENTION . "</p>
                    <p>Contact point(s): " . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->CONTACT_POINT . "</p>
                    <p>" . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->POSTAL_CODE . " " . $news_cur_town . "</p>
                    <p>$news_cur_city</p>
                    <p>Telephone : " . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->PHONE . "</p>
                    <p>E-mail: " . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->E_MAILS->E_MAIL . "</p>
                    <p>Fax : " . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->CA_CE_CONCESSIONAIRE_PROFILE->FAX . "</p>
                    <p style='font-weight: bold;'>Internet address(es):<p>
                    <p>General address of the contracting entity: <a target='_blank' href='http://" . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->INTERNET_ADDRESSES_RESULT_DESIGN_CONTEST->URL_GENERAL . "'>" . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->NAME_ADDRESSES_CONTACT_RESULT_DESIGN_CONTEST->INTERNET_ADDRESSES_RESULT_DESIGN_CONTEST->URL_GENERAL . "</a></p>
                </div>
                <p style='font-weight: bold;'>I.2) Type of the contracting authority</p>
                <p>" . $CONTRACTING_ENTITY_RESULT_DESIGN_CONTEST->TYPE_AND_ACTIVITIES_OR_CONTRACTING_ENTITY_AND_PURCHASING_ON_BEHALF->TYPE_AND_ACTIVITIES->TYPE_OF_CONTRACTING_AUTHORITY_OTHER . "</p>
                <p style='font-weight: bold;'>I.3) Main activity</p>
                <p>" . $CODED_DATA_SECTION->CODIF_DATA->MA_MAIN_ACTIVITIES . "</p>
                <p style='font-weight: bold;'>I.4) Contract award on behalf of other contracting entities</p>
                <p>The contracting authority is purchasing on behalf of other contracting authorities: " . $PROCEDURE_DEFINITION_CONTRACT_AWARD_NOTICE_DEFENCE->AWARD_CRITERIA_CONTRACT_AWARD_NOTICE_INFORMATION->F03_IS_ELECTRONIC_AUCTION_USABLE['VALUE'] . "</p>
            </div>
            ...
            <div style='margin-left: 1em;'>
                <p style='font-weight: bold;'>II.1) Description</p>
                <p style='font-weight: bold;'>II.1.1) Title attributed to the contract</p>
                <p>" . $OBJECT_RESULT_DESIGN_CONTEST->TITLE_RESULT_DESIGN_CONTEST->P . "</p>
                <p style='font-weight: bold;'>II.1.2) Type of contract and location of works, place of delivery or of performance</p>
                <p>" . $OBJECT_RESULT_DESIGN_CONTEST->TITLE_RESULT_DESIGN_CONTEST->TYPE_CONTRACT['VALUE'] . "</p>
                <p>" . $OBJECT_RESULT_DESIGN_CONTEST->TITLE_RESULT_DESIGN_CONTEST->TYPE_SUPPLIES_CONTRACT['VALUE'] . "</p>
                <p>Main site or location of works, place of delivery or of performance: " . $OBJECT_RESULT_DESIGN_CONTEST->TITLE_RESULT_DESIGN_CONTEST->LOCATION->P . "</p>
                <p style='font-weight: bold;'>II.1.3) Information about a framework agreement or a dynamic purchasing system (DPS)</p>
                <p style='font-weight: bold;'>II.1.4) Short description of the contract or purchase(s):</p>
                <p>" . $SHORT_CONTRACT_DESCRIPTION . "</p>
                <p style='font-weight: bold;'>II.1.5) Common procurement vocabulary (CPV)</p>
                ...
                <p>$ORIGINAL_CPV</p>
                <p style='font-weight: bold;'>II.1.6) Information about Government Procurement Agreement (GPA)</p>
                <p>The contract is covered by the Government Procurement Agreement (GPA): " . $OBJECT_RESULT_DESIGN_CONTEST->DESCRIPTION_AWARD_NOTICE_INFORMATION_DEFENCE->CONTRACT_COVERED_GPA['VALUE'] . "</p>
                <p style='font-weight: bold;'>II.2) Total final value of contract(s)</p>
                <p style='font-weight: bold;'>II.2.1) Total final value of contract(s)</p>
                <p>Value : " . $OBJECT_RESULT_DESIGN_CONTEST->TOTAL_FINAL_VALUE->COSTS_RANGE_AND_CURRENCY_WITH_VAT_RATE->VALUE_COST . " " . $OBJECT_CONTRACT_INFORMATION_CONTRACT_AWARD_NOTICE->TOTAL_FINAL_VALUE->COSTS_RANGE_AND_CURRENCY_WITH_VAT_RATE['CURRENCY'] . "</p>
            </div>
            ...
            <div style='margin-left: 1em;'>
                ...
                <p>" . $CRITERIA_DEFINITION_VAL . "</p>
                <p style='font-weight: bold;'>IV.2.2) Information about electronic auction</p>
                <p>An electronic auction has been used : " . $PROCEDURES_RESULT_DESIGN_CONTEST->AWARD_CRITERIA_CONTRACT_AWARD_NOTICE_INFORMATION_DEFENCE->F18_IS_ELECTRONIC_AUCTION_USABLE['VALUE'] . "</p>
                <p style='font-weight: bold;'>IV.3) Administrative information</p>
                <p style='font-weight: bold;'>IV.3.1) File reference number attributed by the contracting entity:</p>
                <p>" . $PROCEDURES_RESULT_DESIGN_CONTEST->FILE_REFERENCE_NUMBER->P . "</p>
                <p style='font-weight: bold;'>IV.3.2) Previous publication(s) concerning the same contract</p>
                <p>Notice number in the OJEU: " . $PROCEDURES_RESULT_DESIGN_CONTEST->PREVIOUS_PUBLICATION_OJ->NOTICE_NUMBER_OJ . " of " . $PROCEDURES_RESULT_DESIGN_CONTEST->PREVIOUS_PUBLICATION_OJ->DATE_OJ->DAY . "." . $PROCEDURES_RESULT_DESIGN_CONTEST->PREVIOUS_PUBLICATION_OJ->DATE_OJ->MONTH . "." . $PROCEDURES_RESULT_DESIGN_CONTEST->PREVIOUS_PUBLICATION_OJ->DATE_OJ->YEAR . "</p>
            </div>

            <p style='font-weight: bold;text-decoration: underline'>Section V: Results of contract</p>
            <div style='margin-left: 1em;'>
                " . $AWARD_OF_CONTRACT_VAL . "
            </div>
            ...
            <div style='margin-left: 1em;'>
                ...
                <p style='font-weight: bold;'>VI.3) Procedures for appeal</p>
                <p style='font-weight: bold;'>VI.3.1) Body responsible for appeal procedures</p>
                <p style='margin-left: 3em;'>" . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->ORGANISATION->OFFICIALNAME . "</p>
                <p style='margin-left: 3em;'>" . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->ADDRESS . "</p>
                <p style='margin-left: 3em;'>" . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->POSTAL_CODE . " " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->TOWN . "</p>
                <p style='margin-left: 3em;'>" . getCountryName($COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->COUNTRY['VALUE']) . "</p>
                <p style='margin-left: 3em;'>E-mail: " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->E_MAILS->E_MAIL . "</p>
                <p style='margin-left: 3em;'>Telephone: " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->PHONE . "</p>
                <p style='margin-left: 3em;'>Internet address : " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->URL . "</p>
                <p style='margin-left: 3em;'>Fax: " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->RESPONSIBLE_FOR_APPEAL_PROCEDURES->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->FAX . "</p>
                <p style='font-weight: bold;'>VI.3.2) Lodging of appeals</p>
                <p>" . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->INFO_ON_DEADLINE->P . "</p>
                <p style='font-weight: bold;'>VI.3.3) Service from which information about the lodging of appeals may be obtained</p>
                <p style='margin-left: 3em;'>" . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->ORGANISATION->OFFICIALNAME . "</p>
                <p style='margin-left: 3em;'>" . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->ADDRESS . "</p>
                <p style='margin-left: 3em;'>" . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->POSTAL_CODE . " " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->TOWN . "</p>
                <p style='margin-left: 3em;'>" . getCountryName($COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->COUNTRY['VALUE']) . "</p>
                <p style='margin-left: 3em;'>E-mail: " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->E_MAILS->E_MAIL . "</p>
                <p style='margin-left: 3em;'>Telephone: " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->PHONE . "</p>
                <p style='margin-left: 3em;'>Internet address : " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->URL . "</p>
                <p style='margin-left: 3em;'>Fax: " . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->APPEAL_PROCEDURES->SERVICE_FROM_INFORMATION->CONTACT_DATA_WITHOUT_RESPONSIBLE_NAME->FAX . "</p>
                <p style='font-weight: bold;'>VI.3.4) Date of dispatch of this notice:</p>
                <p style='margin-left: 3em;'>" . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->NOTICE_DISPATCH_DATE->DAY . "." . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->NOTICE_DISPATCH_DATE->MONTH . "." . $COMPLEMENTARY_INFORMATION_RESULT_DESIGN_CONTEST->NOTICE_DISPATCH_DATE->YEAR . "</p>
            </div>
        </div>";
...
function contract_award_Services($xml, $db2 = NULL, $db2 = NULL) {
    foreach ($xml->TRANSLATION_SECTION->ML_TITLES->ML_TI_DOC as $ml_ti) {
        if ($ml_ti['LG'] == 'EN') {
            $short_descp = str_replace("'", "\'", $ml_ti->TI_TEXT->P);
